...
export function LandingPage({ onGetStarted }: LandingPageProps) {
  ...
  return (
    <div className="bg-gradient-subtle">
      ...
      {/* Features Section - Visual Workflow - 100vh */}
      <section className="min-h-screen flex items-center justify-center px-4 bg-white/50">
        <div className="max-w-7xl mx-auto w-full">
          ...
          {/* Compact Visual Workflow - No Scroll */}
          <div className="glass rounded-2xl p-4 border border-white/20 shadow-card">
            <div className="flex items-start gap-3 justify-center flex-wrap md:flex-nowrap">
              {/* Step 1: Upload */}
          ...
          {/* Iterative Processing - Compact */}
          <div className="mt-8">
            <div className="text-center mb-4">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-amber-50 border border-amber-200 mb-2">
                <GitBranch className="h-3.5 w-3.5 text-amber-600" />
                <span className="text-xs font-semibold text-amber-700">İteratif İşleme</span>
              </div>
            ...
            <div className="glass rounded-xl p-6 border border-white/20 shadow-card">
              <div className="flex flex-col md:flex-row items-center gap-4">
                {/* Source Selection */}
                <div className="flex-shrink-0">
                  <div className="glass-subtle rounded-lg p-3 border-2 border-primary/30">
                    <div className="flex items-center gap-2 mb-2">
                      <GitBranch className="h-4 w-4 text-primary" />
                      <span className="text-xs font-bold text-gray-900">Kaynak Seç</span>
                    </div>
                    <div className="w-20 h-20 rounded-lg bg-gray-100 border-2 border-dashed border-blue-300 flex items-center justify-center">
                      <ImageIcon className="h-6 w-6 text-blue-400" />
                    </div>
                    <p className="text-[10px] text-gray-600 mt-1 text-center">Pipeline'dan</p>
                  </div>
                </div>
                  ...
                  <div className="glass-subtle rounded-lg p-3 border border-white/20">
                    <div className="flex items-center gap-2 mb-2">
                      <div className="w-5 h-5 rounded bg-purple-100 flex items-center justify-center">
                        <span className="text-purple-600 text-[10px] font-bold">2</span>
                      </div>
      ...
      {/* AI Models + Source Image + Modular - 100vh Combined */}
      <section className="min-h-screen flex items-center justify-center px-4 bg-gradient-subtle">
        <div className="max-w-7xl mx-auto w-full">
          ...
          {/* Source Image Section - Detailed Workflow */}
          ...
          {/* Visual Workflow */}
          <div className="glass rounded-xl p-4 border border-white/20 shadow-card max-w-4xl mx-auto mb-6">
      ...
      {/* CTA Section - Compact */}
      <section className="py-8 px-4 bg-gradient-primary text-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <Button
            size="lg"
            onClick={onGetStarted}
            className="bg-white text-primary hover:bg-white/90 text-base px-6 py-4 shadow-card-hover mb-4"
          >
            Hemen Başla
